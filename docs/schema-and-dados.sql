...
INSERT IGNORE INTO `amigo` (`id`, `nome`) VALUES
	(1, 'Luiz Carlos Correia Moura Theodoro'),
	(2, 'José Antônio de Domenico'),
	(3, 'Paulo Henrique de Oliveira Souza');
...
-- Copiando dados para a tabela api-amigos.evento: ~7 rows (aproximadamente)
...
-- Copiando dados para a tabela api-amigos.evento_convidados: ~17 rows (aproximadamente)
...
-- Copiando dados para a tabela api-amigos.tipoevento: ~2 rows (aproximadamente)
